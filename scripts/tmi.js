var tmi = (() => {
    ...
    "lib/EventEmitter.js"(exports, module) {
      var EventEmitter = class {
        ...
        emit(eventType, ...args) {
          if (
            eventType === "error" &&
            (!this._events.has("error") || !this._events.get("error").length)
          ) {
        ...
        listenerCount(eventType) {
          return this._events.get(eventType)
            ? this._events.get(eventType).length
            : 0;
        }
      };
      ...
      module.exports = {
        ...
        formTags(tags = {}) {
          const result = Object.entries(tags).map(
            ([k, v]) => `${_.escapeIRC(k)}=${_.escapeIRC(v)}`
          );
    ...
    "lib/Queue.js"(exports, module) {
      var Queue = class {
        ...
        next() {
          ...
          if (next) {
            const delay =
              next.delay === void 0 ? this.defaultDelay : next.delay;
      ...
      var ClientBase = class extends EventEmitter {
        constructor(opts) {
          ...
          this._globalDefaultChannel = _.channel(
            (_f = this.opts.options.globalDefaultChannel) != null
              ? _f
              : "#tmijs"
          );
          this._skipMembership =
            (_g = this.opts.options.skipMembership) != null ? _g : false;
          this.maxReconnectAttempts =
            (_h = this.opts.connection.maxReconnectAttempts) != null
              ? _h
              : Infinity;
          this.maxReconnectInterval =
            (_i = this.opts.connection.maxReconnectInterval) != null ? _i : 3e4;
          this.reconnect =
            (_j = this.opts.connection.reconnect) != null ? _j : true;
          this.reconnectDecay =
            (_k = this.opts.connection.reconnectDecay) != null ? _k : 1.5;
          this.reconnectInterval =
            (_l = this.opts.connection.reconnectInterval) != null ? _l : 1e3;
          ...
          this.secure =
            (_m = this.opts.connection.secure) != null
              ? _m
        ...
        handleMessage(message) {
          ...
          const channel = _.channel(
            (_a2 = message.params[0]) != null ? _a2 : null
          );
          const msg = (_b = message.params[1]) != null ? _b : null;
          const msgid = (_c = message.tags["msg-id"]) != null ? _c : null;
          const tags = (message.tags = parser.badges(
            parser.badgeInfo(parser.emotes(message.tags))
          ));
          ...
          if (message.prefix === null) {
            switch (message.command) {
              ...
              case "PONG": {
                this.currentLatency =
                  (new Date().getTime() - this.latency.getTime()) / 1e3;
  ...
  ${JSON.stringify(message, null, 4)}`);
            ...
            switch (message.command) {
              ...
              case "376": {
                ...
                let joinInterval =
                  (_d = this.opts.options.joinInterval) != null ? _d : 2e3;
                if (joinInterval < 300) {
                  joinInterval = 300;
                }
              ...
              case "NOTICE": {
                ...
                switch (msgid) {
                  ...
                  case "vips_success": {
                    const listSplit = (
                      msg.endsWith(".") ? msg.slice(0, -1) : msg
                    ).split(": ");
  ...
  ${JSON.stringify(message, null, 4)}`);
              ...
              case "USERNOTICE": {
                ...
                const plan =
                  (_e = tags["msg-param-sub-plan"]) != null ? _e : "";
                const planName =
                  _.unescapeIRC(
                    (_f = tags["msg-param-sub-plan-name"]) != null ? _f : ""
                  ) || null;
              ...
              case "CLEARCHAT":
                if (message.params.length > 1) {
                  const duration =
                    (_g = message.tags["ban-duration"]) != null ? _g : null;
                  if (duration === null) {
                  ...
                  this.log.info(
                    `[${channel}] Chat was cleared by a moderator.`
                  );
                  this.emits(
              ...
              case "GLOBALUSERSTATE":
                ...
                if (
                  message.tags["emote-sets"] !== void 0 &&
                  message.tags["emote-sets"] !== this.emotes
                ) {
                  this.emotes = message.tags["emote-sets"];
                  this.emit("emotesets", this.emotes, null);
                }
  ...
  ${JSON.stringify(message, null, 4)}`);
            ...
            switch (message.command) {
              ...
              case "JOIN": {
                ...
                const isSelfAnon =
                  matchesUsername && _.isJustinfan(this.getUsername());
                if (isSelfAnon) {
                  this.lastJoined = channel;
                  this.channels.push(channel);
                  this.log.info(`Joined ${channel}`);
              ...
              case "PRIVMSG":
                ...
                if (message.tags.username === "jtv") {
                  ...
                  const messagesLogLevel =
                    (_h = this.opts.options.messagesLogLevel) != null
                      ? _h
                      : "info";
                  const isActionMessage = _.actionMessage(msg);
                  message.tags["message-type"] = isActionMessage
                    ? "action"
                    : "chat";
                  ...
                  if (_.hasOwn(message.tags, "bits")) {
                    ...
                    if (isActionMessage) {
                      this.log[messagesLogLevel](
                        `[${channel}] *<${message.tags.username}>: ${cleanedMsg}`
                      );
                      this.emits(
                        ["action", "message"],
  ...
  ${JSON.stringify(message, null, 4)}`);
        ...
        connect() {
          return new Promise((resolve, reject) => {
            var _a2, _b;
            this.server =
              (_a2 = this.opts.connection.server) != null
                ? _a2
        ...
        _openConnection() {
          const url = `${this.secure ? "wss" : "ws"}://${this.server}:${
            this.port
          }/`;
        ...
        _onOpen() {
          ...
          this.username = _.username(
            (_a2 = this.opts.identity.username) != null ? _a2 : _.justinfan()
          );
          this._getToken()
            .then((token) => {
        ...
        _getToken() {
          ...
          const password =
            typeof passwordOption === "function"
              ? passwordOption()
              : passwordOption;
        ...
        _sendCommand({ delay, channel, command, tags }, fn) {
          return new Promise((resolve, reject) => {
            ...
            if (typeof channel === "string") {
              ...
              this.ws.send(
                `${
                  formedTags ? `${formedTags} ` : ""
                }PRIVMSG ${chan} :${command}`
              );
            } else {
        ...
        _sendMessage({ channel, message, tags }, fn) {
          return new Promise((resolve, reject) => {
            ...
            const formedTags = parser.formTags(tags);
            this.ws.send(
              `${formedTags ? `${formedTags} ` : ""}PRIVMSG ${chan} :${message}`
            );
            const userstate = Object.assign({}, this.userstate[chan], {
              emotes: null,
            });
            const messagesLogLevel =
              (_a2 = this.opts.options.messagesLogLevel) != null ? _a2 : "info";
      ...
      var Client = class extends ClientBase {
        ...
        announce(channel, message) {
          return this._sendMessage(
            { channel, message: `/announce ${message}` },
            (res, _rej) => res([_.channel(channel), message])
          );
        }
        ban(channel, username, reason) {
          ...
          return this._sendCommand(
            { channel, command: `/ban ${username} ${reason}` },
            (res, rej) =>
              this.once("_promiseBan", (err) =>
                !err ? res([_.channel(channel), username, reason]) : rej(err)
              )
          );
        }
        clear(channel) {
          return this._sendCommand({ channel, command: "/clear" }, (res, rej) =>
            this.once("_promiseClear", (err) =>
              !err ? res([_.channel(channel)]) : rej(err)
            )
          );
        }
        ...
        commercial(channel, seconds) {
          ...
          return this._sendCommand(
            { channel, command: `/commercial ${seconds}` },
            (res, rej) =>
              this.once("_promiseCommercial", (err) =>
                !err ? res([_.channel(channel), ~~seconds]) : rej(err)
              )
          );
        }
        deletemessage(channel, messageUUID) {
          return this._sendCommand(
            { channel, command: `/delete ${messageUUID}` },
            (res, rej) =>
        ...
        followersonly(channel, minutes) {
          ...
          return this._sendCommand(
            { channel, command: `/followers ${minutes}` },
            (res, rej) =>
              this.once("_promiseFollowers", (err) =>
                !err ? res([_.channel(channel), ~~minutes]) : rej(err)
              )
          );
        }
        followersonlyoff(channel) {
          return this._sendCommand(
            { channel, command: "/followersoff" },
            (res, rej) =>
        ...
        host(channel, target) {
          ...
          return this._sendCommand(
            { delay: 2e3, channel, command: `/host ${target}` },
            (res, rej) =>
              this.once("_promiseHost", (err, remaining) =>
                !err ? res([_.channel(channel), target, ~~remaining]) : rej(err)
              )
          );
        }
        join(channel) {
          ...
          return this._sendCommand(
            { delay: void 0, channel: null, command: `JOIN ${channel}` },
            (res, rej) => {
        ...
        mod(channel, username) {
          username = _.username(username);
          return this._sendCommand(
            { channel, command: `/mod ${username}` },
            (res, rej) =>
              this.once("_promiseMod", (err) =>
                !err ? res([_.channel(channel), username]) : rej(err)
              )
          );
        }
        mods(channel) {
        ...
        part(channel) {
          return this._sendCommand(
            { delay: null, channel: null, command: `PART ${channel}` },
            (res, rej) =>
        ...
        raw(command, tags) {
          return this._sendCommand(
            { channel: null, command, tags },
            (res, _rej) => res([command])
          );
        }
        ...
        say(channel, message, tags) {
          ...
          if (
            ...
            if (message.slice(1, 4) === "me ") {
              ...
              return this._sendCommand(
                { channel, command: message, tags },
                (res, _rej) => res([channel, message])
              );
            }
          }
          return this._sendMessage({ channel, message, tags }, (res, _rej) =>
        ...
        subscribersoff(channel) {
          return this._sendCommand(
            { channel, command: "/subscribersoff" },
            (res, rej) =>
        ...
        timeout(channel, username, seconds, reason) {
          ...
          reason = reason != null ? reason : "";
          return this._sendCommand(
            { channel, command: `/timeout ${username} ${seconds} ${reason}` },
            (res, rej) =>
              this.once("_promiseTimeout", (err) =>
                !err
                  ? res([_.channel(channel), username, ~~seconds, reason])
                  : rej(err)
              )
          );
        }
        unban(channel, username) {
          username = _.username(username);
          return this._sendCommand(
            { channel, command: `/unban ${username}` },
            (res, rej) =>
        ...
        unhost(channel) {
          return this._sendCommand(
            { delay: 2e3, channel, command: "/unhost" },
            (res, rej) =>
        ...
        unmod(channel, username) {
          username = _.username(username);
          return this._sendCommand(
            { channel, command: `/unmod ${username}` },
            (res, rej) =>
        ...
        unvip(channel, username) {
          username = _.username(username);
          return this._sendCommand(
            { channel, command: `/unvip ${username}` },
            (res, rej) =>
